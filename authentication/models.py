...
class UserManager(BaseUserManager):
    ...
    def create_user(self, username, email, user_background=None ,avatar=None,password=None, ):
        ...
        if user_background is None:
            user_background = 'user_background/default_background.jpg'

        user = self.model(username=username, email=self.normalize_email(email), avatar = avatar,user_background=user_background )
